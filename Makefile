...
define Package/$(PKG_NAME)
	...
	DEPENDS:=+luci-base +wget +iptables +coreutils-base64 +coreutils +coreutils-nohup +bash +ipset +curl +jsonfilter +ca-certificates +libcap +libcap-bin +iptables-mod-tproxy +kmod-ipt-extra +iptables-mod-extra +kmod-tun
	PKGARCH:=all
